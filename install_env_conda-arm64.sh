...
function install_mpas_env() {
    conda create -y -n mpas python=3.8 mpich fortran-compiler cxx-compiler c-compiler m4 git cmake six netcdf4 xarray matplotlib metis cartopy geometric_features pyevtk pythong-igraph scikit-image pytest
}
